...
def load_known_faces():
    ...
    base_image_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "PHOTOS")

    images = ["Bishal kumar saha.jpeg", "Chandan Parmeshwar Reddy.jpeg",
              "ChandraSekhar.jpeg", "Mohit namburi.jpeg"]
    names = ["BISHAL KUMAR SAHA", "CHANDAN PARMESHWAR REDDY",
             "CHANDRASEKHAR", "MOHIT NAMBURI"]
